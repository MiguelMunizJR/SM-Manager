const ModalDelete = ({ setShowDelete, setIsDelete }) => {
  return (
    <article className="w-8/12 sm:w-1/2 md:w-2/5 lg:w-1/4 h-1/3 mx-auto mt-auto lg:px-2 sm:px-2 flex flex-col justify-evenly items-center rounded-lg drop-shadow-lg font-default font-semibold text-center bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
