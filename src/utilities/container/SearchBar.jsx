    ...
    <article className="ml-12 w-1/3 flex items-center">
      <span className="absolute flex items-center">
        <svg
          ...
          stroke="currentColor"
          viewBox="0 0 24 24"
          className="w-8 h-8 pl-2 text-slate-400 dark:text-gray-500"
        >
