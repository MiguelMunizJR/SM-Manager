...
const NavBar = ({ setIsShowForm, setUpdate }) => {
  return (
    <nav className="w-52 h-screen pt-5 flex flex-col items-center justify-between bg-navBar dark:bg-navBarDark dark:drop-shadow-2xl drop-shadow-2xl shadow-black">
