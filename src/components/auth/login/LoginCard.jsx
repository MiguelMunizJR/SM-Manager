...
const LoginCard = ({ handleSubmit, submitForm, register }) => {
  return (
    <article className="w-5/6 max-w-2xl min-h-max pt-10 sm:py-2 font-default flex flex-col bg-gray-50 sm:mt-28 sm:w-3/5 sm:min-h-max sm:items-center sm:absolute sm:inset-0 sm:inset-x-auto sm:z-10 sm:shadow-lg sm:rounded-lg md:w-3/6 md:flex-row lg:w-2/3">
